    ...
    <div className="min-h-screen bg-[#1C1C1C]">
      ...
      <nav className="flex items-center justify-between py-6 px-4 max-w-7xl mx-auto">
        ...
        <div className="flex gap-4">
          <Link to="/signin">
            <button className="border border-[#FFFFFF] text-[#FFFFFF] hover:bg-[#302F2F]/5 px-4 py-2 rounded-lg font-medium transition-colors">
              Sign In
            </button>
          </Link>
          <Link to="/signup">
            <button className="bg-[#302F2F] hover:bg-[#302F2F]/90 text-[#FFFFFF] px-4 py-2 rounded-lg font-medium flex items-center gap-2 transition-colors">
      ...
      <div className="flex flex-col items-center justify-center text-center py-20 px-4 max-w-4xl mx-auto">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-12 text-[#FFFFFF] leading-tight">
          Simplify Your Legal Workflow
          <br />
          with AI Precision
        </h1>

        <p className="text-[#868686] text-lg md:text-xl mb-4 max-w-3xl">
          Streamline your trademark, patent, and copyright filings with our intelligent platform.
        </p>
        <p className="text-[#868686] text-lg md:text-xl mb-16 max-w-3xl">
          Get higher accuracy and faster approvals with AI assistance.
        </p>

        <Link to="/signup">
          <button className="bg-[#302F2F] hover:bg-[#302F2F]/90 text-[#FFFFFF] rounded-[30px] px-8 py-6 text-lg flex items-center gap-2 transition-colors">
            Try Now <ArrowRight className="h-5 w-5" />
          </button>
        </Link>

        {/* Trust Indicators */}
        <div className="mt-12 flex flex-wrap justify-center gap-28 text-[#868686] max-w-3xl md:max-w-4xl mx-auto px-6 md:px-12">
          <div className="flex items-center">
            <Cpu className="w-5 h-5 text-[#FFFFFF] mr-2" />
            <span>AI-Powered Accuracy</span>
          </div>
          <div className="flex items-center">
            <Shield className="w-5 h-5 text-[#FFFFFF] mr-2" />
            <span>Secure & Compliant</span>
          </div>
          <div className="flex items-center">
            <PhoneCall className="w-5 h-5 text-[#FFFFFF] mr-2" />
            <span>AI-Powered Accuracy</span>
          </div>
        </div>
      </div>
      ...
      {/* Features Section */}
      <div className="bg-[#1C1C1C] py-24 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-[#FFFFFF] text-center mb-6">
            Powerful Features for Your IP Protection
          </h2>
          <p className="text-[#868686] text-center mb-16 max-w-3xl mx-auto text-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="rounded-3xl bg-[#302F2F] overflow-hidden shadow-sm">
                <div className="p-8">
                  {/* Icon container with border */}
                  <div className="mb-6 w-14 h-14 rounded-2xl border border-[#6C6C6C]/50 flex items-center justify-center bg-[#1C1C1C]">
                    {feature.icon}
                  </div>
                  ...
                  <div className="mt-4 bg-[#1C1C1C] p-5 rounded-2xl">
      ...
      <div className="py-24 px-4 max-w-6xl mx-auto">
        <div className="border border-[#6C6C6C] rounded-3xl p-8 md:p-12 shadow-sm bg-[#1C1C1C]">
