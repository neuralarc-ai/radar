      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          <div className='flex items-center gap-2 mb-6'>
            ...
            <h1 className="text-2xl font-bold text-[#000000]">Generated Documents</h1>
          </div>
          
          <p className="text-[#000000]/80 mt-2">Review and download your filing-ready documents</p>
        </div>

        <div className="bg-[#ffffff] border border-[#ffffff] border-[1.2px] rounded-lg shadow overflow-hidden">
        ...
        <div className="mt-8 flex justify-between">
          <button className="px-4 py-2 bg-[#000000] border border-[#000000]/5 border-[1.5px] text-[#FFFFFF] rounded-lg hover:bg-[#302F2F] transition-colors">
            Regenerate
          </button>
          <button
            onClick={handleValidate}
            className="px-4 py-2 bg-[#000000] border border-[#000000]/5 border-[1.5px] text-[#FFFFFF] rounded-lg hover:bg-[#302F2F] transition-colors flex items-center gap-2"
          >
        ...
        {/* Next Steps Section */}
        <div className="mt-12 bg-[#000000] rounded-lg border border-[#6C6C6C] p-6">
          <h2 className="text-xl font-semibold text-[#FFFFFF] mb-6">Next Steps</h2>
          <div className="space-y-6">
            {/* Review Documents */}
            <div className="flex items-start gap-4">
              <div className="p-2 bg-[#e8e8e8] rounded-full">
        ...
        <div className="mt-8 flex justify-end">
          <button 
            className="px-6 py-2 bg-[#000000] border border-[#000000]/5 border-[1.5px] text-[#FFFFFF] rounded-lg hover:bg-[#302F2F] transition-colors flex items-center gap-2" 
