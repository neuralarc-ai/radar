    ...
    <div className="">
      ...
      <div className="">
        <div className="">
          ...
          <div className="bg-[#FFFFFF] rounded-[12px] p-8 min-h-[calc(100vh-144px)]">
            <div className="mb-8">
            ...
            <div className="mt-8 flex justify-between">
              <button className="px-[27px] py-[11px] rounded-[4px] bg-[#2B2521] text-[#FFFFFF] font-medium transition-colors">
                Regenerate
              </button>
              <button
                onClick={handleValidate}
                className="px-[27px] py-[11px] rounded-[4px] bg-[#2B2521] text-[#FFFFFF] font-medium transition-colors flex items-center gap-2"
              >
            ...
            <div className="space-y-8">
              ...
              <div className="bg-[#f8f7f3] rounded-[8px] p-6 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-[#4f4f4f]">Download and carefully review all generated trademark documents for accuracy</p>
                </div>
              </div>
              ...
              <div className="bg-[#f8f7f3] rounded-[8px] p-6 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-[#4f4f4f]">Run our compliance checker to ensure all trademark filing requirements are met</p>
                </div>
              </div>
              ...
              <div className="bg-[#f8f7f3] rounded-[8px] p-6 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-[#4f4f4f]">Use the documents to file your trademark application with the appropriate IP office</p>
                </div>
              </div>
            </div>
