...
const PatentFilingPreparation = () => {
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-[#F8F7F3] rounded-[12px] flex items-center justify-center">
      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          <div className="flex items-center gap-2 mb-6">
            <button
              type="button"
              className="p-2 text-[#FFFFFF] hover:text-[#FFFFFF] transition-colors rounded-[4px] hover:bg-[#302F2F] border border-[#6C6C6C]"
              onClick={() => navigate(-1)}
              aria-label="Go back"
            >
              <IoArrowBack className="w-6 h-6" />
            </button>
            <h1 className="text-2xl font-bold text-[#322B25]">Patent Filing Preparation</h1>
          </div>
        </div>
