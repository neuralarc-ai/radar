...
import filingBg from '../assests/bg/filling.png'; // Import background image
...
const PatentFiling = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FBFAF8] ">
      ...
      <div className="rounded-[16px] p-6 mb-8 relative z-10" style={{ backgroundImage: `url(${filingBg})`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>
