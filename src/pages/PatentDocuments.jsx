      ...
      <div className="" >
        ...
        <div className="mb-8">
          <div className='flex items-center gap-2 mb-6'>
            <button 
              type="button"
              className="p-2 text-[#202020] hover:text-[#FFFFFF] transition-colors rounded-[4px] "
              onClick={() => navigate(-1)}
              aria-label="Go back"
            >
              <IoArrowBack className="w-6 h-6" />
            </button>
            <h1 className="text-2xl font-bold text-[#322B25]">Generated Patent Documents</h1>
          </div>
          
          <p className="text-[#4F4F4F] mt-2">Review and download your patent filing-ready documents</p>
        </div>
