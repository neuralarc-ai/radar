      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          <div className="flex items-center gap-2 mb-6">
            <button
              type="button"
              className="p-2 text-[#000000  ] hover:text-[#868686] transition-colors rounded-[25%] hover:bg-[#302F2F] border border-[#6C6C6C]"
              onClick={() => navigate(-1)}
              aria-label="Go back"
            >
              <IoArrowBack className="w-6 h-6" />
            </button>
            <h1 className="text-2xl font-bold text-[#000000]">Document Generation</h1>
          </div>
          <p className="text-[#868686] mt-2">Generate and manage filing-ready documents for your trademark application</p>
        </div>
        ...
        <div className="bg-[#ffffff] rounded-lg border border-[#ffffff] border-[1.2px] p-6 mb-8">
          ...
          <div className="text-center mb-10">
            ...
            <h3 className="text-xl font-medium text-[#000000] mb-2">Ready to generate your trademark filing documents</h3>
          </div>
          ...
          <div className="bg-[#e8e8e8] rounded-lg p-8 mb-10">
            <div className="max-w-3xl mx-auto space-y-3">
              <div className="flex items-start space-x-2">
                ...
                <p className="text-[#000000] text-sm">Documents will be tailored based on your application details</p>
              </div>
              <div className="flex items-start space-x-2">
                <div className="flex-shrink-0 mt-1">
                  <svg className="w-3 h-3 text-[#000000]" fill="currentColor" viewBox="0 0 24 24">
                ...
                <p className="text-[#000000] text-sm">All required USPTO/IP office forms will be prepared</p>
              </div>
              <div className="flex items-start space-x-2">
                <div className="flex-shrink-0 mt-1">
                  <svg className="w-3 h-3 text-[#000000]" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-start space-x-2">
                ...
                <p className="text-[#000000] text-sm">AI-powered validation ensures compliance with filing requirements</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-center">
            <button
              ...
              className={`px-8 py-3 bg-[#000000] text-[#FFFFFF] rounded-lg hover:bg-[#6C6C6C] transition-colors flex items-center space-x-2 ${
